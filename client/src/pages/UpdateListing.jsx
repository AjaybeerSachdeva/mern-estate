    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-4 flex-1'>
                ...
                placeholder='Description' id='description' required onChange={handleChange}
                value={formData.description}/>
                <input className='border p-3 focus:outline-none rounded-lg' type='text' 
                placeholder='Address' id='address' required onChange={handleChange}
            ...
            <div className='flex flex-col flex-1 gap-4'>
                ...
                <div className='flex gap-4'>
                    <input onChange={(e)=>setFiles(e.target.files)} className='p-3 border border-gray-300 rounded w-full' type="file" 
                    id='images' accept='image/*' multiple/>
                    <button disabled={uploading} type='button' onClick={handleImageSubmit} className='p-3 text-green-700 rounded-lg border
                     border-green-700 uppercase hover:shadow-lg disabled:opacity-80'>
                ...
                <button disabled={loading || uploading} className='p-3 text-white rounded-lg bg-slate-700 uppercase
